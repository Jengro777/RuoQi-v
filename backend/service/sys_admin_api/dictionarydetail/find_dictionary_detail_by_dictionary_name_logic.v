...
// ----------------- Handler 层 -----------------
@['/detail'; post]
pub fn (app &DictionaryDetail) find_dictionary_detail_by_dictionary_name_handler(mut ctx Context) veb.Result {
	...
	result := find_dictionary_detail_by_dictionary_name_usecase(mut ctx, req) or {
...
// ----------------- Usecase 层 -----------------
pub fn find_dictionary_detail_by_dictionary_name_usecase(mut ctx Context, req GetDictionaryDetailReq) !GetDictionaryDetailResp {
	// 参数校验
	find_dictionary_detail_by_dictionary_name_domain(req)!

	// Repository 获取数据
	return find_dictionary_detail_by_dictionary_name_repo(mut ctx, req)
}

// ----------------- Domain 层 -----------------
fn find_dictionary_detail_by_dictionary_name_domain(req GetDictionaryDetailReq) ! {
...
// ----------------- Repository 层 -----------------
fn find_dictionary_detail_by_dictionary_name_repo(mut ctx Context, req GetDictionaryDetailReq) !GetDictionaryDetailResp {
