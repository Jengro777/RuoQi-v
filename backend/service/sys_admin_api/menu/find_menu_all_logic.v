...
pub fn find_menu_all_usecase(mut ctx Context) !MenuListResp {
	find_menu_all_domain()
	return find_menu_all(mut ctx)
}

// ----------------- Domain 层 -----------------
fn find_menu_all_domain() {
}
...
// ----------------- Repository 层 -----------------
fn find_menu_all(mut ctx Context) !MenuListResp {
