...
// ----------------- Handler 层 -----------------
@['/system/list'; get]
pub fn (app &Authentication) find_configuration_sys_all_handler(mut ctx Context) veb.Result {
	log.debug('${@METHOD}  ${@MOD}.${@FILE_LINE}')

	// Usecase 执行
	result := find_configuration_sys_all_usecase(mut ctx) or {
...
pub fn find_configuration_sys_all_usecase(mut ctx Context) !GetConfigurationSystemListResp {
	// Domain 校验
	find_configuration_sys_all_domain()!

	// Repository 查询
	return find_configuration_sys_all_repo(mut ctx)
}

// ----------------- Domain 层 -----------------
fn find_configuration_sys_all_domain() ! {
	//
}
...
// ----------------- Repository 层 -----------------
fn find_configuration_sys_all_repo(mut ctx Context) !GetConfigurationSystemListResp {
