...
pub fn (app &Token) find_token_all_handler(mut ctx Context) veb.Result {
	...
	result := find_token_all_usecase(mut ctx, req) or {
...
// ----------------- Usecase 层 -----------------
pub fn find_token_all_usecase(mut ctx Context, req TokenListReq) !TokenListResp {
	// Domain 校验
	find_token_all_domain(req)!

	// Repository 查询
	return find_token_all(mut ctx, req)
}

// ----------------- Domain 层 -----------------
fn find_token_all_domain(req TokenListReq) ! {
...
// ----------------- Repository 层 -----------------
fn find_token_all(mut ctx Context, req TokenListReq) !TokenListResp {
