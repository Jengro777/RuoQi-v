...
// ----------------- Handler 层 -----------------
@['/all'; post]
pub fn (app &Configuration) find_configuration_all_handler(mut ctx Context) veb.Result {
	...
	// Usecase 执行
	result := find_configuration_all_usecase(mut ctx, req) or {
...
pub fn find_configuration_all_usecase(mut ctx Context, req GetConfigurationListReq) !GetConfigurationListResp {
	// Domain 校验
	find_configuration_all_domain(req)!

	// Repository 查询
	return find_configuration_all_repo(mut ctx, req)
}

// ----------------- Domain 层 -----------------
fn find_configuration_all_domain(req GetConfigurationListReq) ! {
...
// ----------------- Repository 层 -----------------
fn find_configuration_all_repo(mut ctx Context, req GetConfigurationListReq) !GetConfigurationListResp {
