...
pub fn (app &RolePermission) find_role_api_all_handler(mut ctx Context) veb.Result {
	...
	result := find_role_api_all_usecase(mut ctx, req) or {
...
// ----------------- Usecase 层 -----------------
pub fn find_role_api_all_usecase(mut ctx Context, req GetRoleApiListReq) !map[string][]GetRoleApiListResp {
	// Domain 校验
	find_role_api_all_domain(req)!

	// Repository 查询
	return find_role_api_all_repo(mut ctx, req)
}

// ----------------- Domain 层 -----------------
fn find_role_api_all_domain(req GetRoleApiListReq) ! {
...
// ----------------- Repository 层 -----------------
fn find_role_api_all_repo(mut ctx Context, req GetRoleApiListReq) !map[string][]GetRoleApiListResp {
