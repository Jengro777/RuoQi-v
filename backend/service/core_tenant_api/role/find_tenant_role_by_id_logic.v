...
// ----------------- Handler 层 -----------------
@['/tenant_role/id'; post]
pub fn (app &Role) find_tenant_role_by_id_handler(mut ctx Context) veb.Result {
	...
	result := find_tenant_role_by_id_usecase(mut ctx, req) or {
...
pub fn find_tenant_role_by_id_usecase(mut ctx Context, req GetTenantRoleByIdReq) ![]GetCoreApiByListResp {
	// Domain 校验
