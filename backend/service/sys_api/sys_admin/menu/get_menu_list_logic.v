...
// ----------------- Handler 层 -----------------
@['/list'; get]
pub fn (app &Menu) get_menu_list_handler(mut ctx Context) veb.Result {
	log.debug('${@METHOD}  ${@MOD}.${@FILE_LINE}')

	result := get_menu_list_usecase(mut ctx) or {
...
pub fn get_menu_list_usecase(mut ctx Context) !MenuListResp {
	get_menu_list_domain()
	return get_menu_list(mut ctx)
}

// ----------------- Domain 层 -----------------
fn get_menu_list_domain() {
}
...
// ----------------- Repository 层 -----------------
fn get_menu_list(mut ctx Context) !MenuListResp {
