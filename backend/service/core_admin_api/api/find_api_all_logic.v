...
// ----------------- Usecase 层 -----------------
pub fn find_api_all_usecase(mut ctx Context, req GetCoreApiByListReq) !GetCoreApiByListResp {
	// Domain 校验
	find_api_all_domain(req)!

	// Repository 查询
	return find_api_all_repo(mut ctx, req)
}

// ----------------- Domain 层 -----------------
fn find_api_all_domain(req GetCoreApiByListReq) ! {
...
// ----------------- Repository 层 -----------------
fn find_api_all_repo(mut ctx Context, req GetCoreApiByListReq) !GetCoreApiByListResp {
