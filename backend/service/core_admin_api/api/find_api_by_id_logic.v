...
pub fn find_api_by_id_usecase(mut ctx Context, req GetCoreApiByIDReq) ![]GetCoreApiByIDResp {
	// Domain 层校验参数
...
// ----------------- Domain 层 -----------------
fn find_api_by_id_domain(req GetCoreApiByIDReq) ! {
	if req.id == '' {
...
// ----------------- Repository 层 -----------------
fn find_api_by_id_repo(mut ctx Context, req GetCoreApiByIDReq) ![]GetCoreApiByIDResp {
