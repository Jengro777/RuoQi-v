...
// ----------------- Handler 层 -----------------
@['/project/list'; post]
pub fn (app &Project) find_project_all_handler(mut ctx Context) veb.Result {
	...
	result := find_project_all_usecase(mut ctx, req) or {
...
pub fn find_project_all_usecase(mut ctx Context, req GetCoreProjectByListReq) !GetCoreProjectByListResp {
	// 参数校验
	find_project_all_domain(req)!

	// 调用 Repository 层
	return find_project_all_repo(mut ctx, req)
}

// ----------------- Domain 层 -----------------
fn find_project_all_domain(req GetCoreProjectByListReq) ! {
...
// ----------------- Repository 层 -----------------
fn find_project_all_repo(mut ctx Context, req GetCoreProjectByListReq) !GetCoreProjectByListResp {
