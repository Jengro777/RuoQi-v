...
// ----------------- Handler 层 -----------------
@['/menu/list'; post]
pub fn (app &Menu) find_menu_all_handler(mut ctx Context) veb.Result {
	...
	result := find_menu_all_usecase(mut ctx, req) or {
...
// ----------------- Usecase 层 -----------------
pub fn find_menu_all_usecase(mut ctx Context, req GetMenuListReq) !GetMenuListResp {
	find_menu_all_domain(req)!
	return find_menu_all_repo(mut ctx, req)
}

// ----------------- Domain 层 -----------------
fn find_menu_all_domain(req GetMenuListReq) ! {
	if req.page <= 0 {
...
// ----------------- Repository 层 -----------------
fn find_menu_all_repo(mut ctx Context, req GetMenuListReq) !GetMenuListResp {
