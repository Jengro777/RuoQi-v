...
// ----------------- Handler 层 -----------------
@['/role/list'; get]
pub fn (app &Menu) find_menu_all_by_role_handler(mut ctx Context) veb.Result {
	...
	result := find_menu_all_by_role_usecase(mut ctx, req) or {
...
pub fn find_menu_all_by_role_usecase(mut ctx Context, req GetMenuListByRoleReq) !GetMenuListByRoleResp {
	// Domain 参数校验
	// find_menu_all_by_role_domain(req)!

	// Repository 查询
	return find_menu_all_by_role_repo(mut ctx, req)
}

// ----------------- Domain 层 -----------------
// fn find_menu_all_by_role_domain(req GetMenuListByRoleReq) ! {
// 	//
// }
...
// ----------------- Repository 层 -----------------
fn find_menu_all_by_role_repo(mut ctx Context, req GetMenuListByRoleReq) !GetMenuListByRoleResp {
