...
// ----------------- Handler 层 -----------------
@['/list'; get]
pub fn (app &RegionAdmDiv) get_region_adm_list_handler(mut ctx Context) veb.Result {
	...
	result := get_region_adm_list_usecase(mut ctx, req) or {
...
pub fn get_region_adm_list_usecase(mut ctx Context, req RegionAdmListReq) !RegionAdmListResp {
	get_region_adm_list_domain()
	return get_region_adm_list(mut ctx, req)
}

// ----------------- Domain 层 -----------------
fn get_region_adm_list_domain() {
}
...
// ----------------- Repository 层 -----------------
fn get_region_adm_list(mut ctx Context, req RegionAdmListReq) !RegionAdmListResp {
