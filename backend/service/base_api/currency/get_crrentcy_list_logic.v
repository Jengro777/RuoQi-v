...
// ----------------- Handler 层 -----------------
@['/list'; get]
pub fn (app &Currency) get_currency_list_handler(mut ctx Context) veb.Result {
	...
	result := get_currency_list_usecase(mut ctx, req) or {
...
pub fn get_currency_list_usecase(mut ctx Context, req CurrencyListReq) !CurrencyListResp {
	get_currency_list_domain()
	return get_currency_list(mut ctx, req)
}

// ----------------- Domain 层 -----------------
fn get_currency_list_domain() {
}
...
// ----------------- Repository 层 -----------------
fn get_currency_list(mut ctx Context, req CurrencyListReq) !CurrencyListResp {
