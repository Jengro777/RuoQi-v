...
pub:
	...
	decimal_place             u8 @[comment: '小数位数'; default: 5; required; sql_type: 'smallint']
	exchange_rate             f64 @[comment: '汇率'; required; sql_type: 'double precision']
	exchange_rate_fluctuation f64 @[comment: '汇率波动'; required; sql_type: 'double precision']
	exchange_rate_used        f64 @[comment: '使用的汇率'; required; sql_type: 'double precision']
