...
pub:
	...
	subproduct_id string @[comment: '产品订阅实例ID'; sql_type: 'CHAR(36)']
	amount        f64 @[comment: '金额'; sql_type: 'DECIMAL(12,2)']
	currency      string @[comment: '货币'; sql_type: "VARCHAR(8) DEFAULT 'CNY'"]
	status        u8 @[comment: '0待支付 1已支付 2逾期 3已取消'; default: 0; sql_type: 'smallint']
